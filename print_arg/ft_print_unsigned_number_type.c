...
/*   Updated: 2021/01/17 11:44:45 by apending         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../printf.h"

void ft_print_unsigned_number_width(s_arg s_arg, int *print_c)
{
	char width_c;
...
void ft_print_unsigned_number(long int num, s_arg s_arg, int *print_c)
{
	char c;
	...
	(*print_c)++;
	if (num != 0)
		ft_print_unsigned_number(num, s_arg, print_c);
	else
		ft_print_unsigned_number_width(s_arg, print_c);

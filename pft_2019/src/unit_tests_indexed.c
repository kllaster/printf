...
const t_test_entry g_unit_tests[] = {
	...
	{0, 123, "s_undefbehav_0_2zero", s_undefbehav_0_2zero, s_undefbehav_0_2zero_bench, "{return test(\"%00s\", s_hidden);}"},
	{0, 124, "s_undefbehav_0_3zero", s_undefbehav_0_3zero, s_undefbehav_0_3zero_bench, "{return test(\"%000s\", s_hidden);}"},
	{0, 125, "s_undefbehav_0_4zero", s_undefbehav_0_4zero, s_undefbehav_0_4zero_bench, "{return test(\"%0000s\", s_hidden);}"},
	{0, 126, "s_undefbehav_0_lj_2zero", s_undefbehav_0_lj_2zero, s_undefbehav_0_lj_2zero_bench, "{return test(\"%-00s\", s_hidden);}"},
	{0, 127, "s_undefbehav_0_zero_lj_zero", s_undefbehav_0_zero_lj_zero, s_undefbehav_0_zero_lj_zero_bench, "{return test(\"%0-0s\", s_hidden);}"},
	{0, 128, "s_undefbehav_0_2zero_lj", s_undefbehav_0_2zero_lj, s_undefbehav_0_2zero_lj_bench, "{return test(\"%00-s\", s_hidden);}"},
	{0, 129, "s_undefbehav_0_width_3", s_undefbehav_0_width_3, s_undefbehav_0_width_3_bench, "{return test(\"%03s\", s_hidden);}"},
	{0, 130, "s_undefbehav_0_width_9", s_undefbehav_0_width_9, s_undefbehav_0_width_9_bench, "{return test(\"%09s\", s_hidden);}"},
	{0, 131, "s_undefbehav_lj_0_width_3", s_undefbehav_lj_0_width_3, s_undefbehav_lj_0_width_3_bench, "{return test(\"%-03s\", s_hidden);}"},
	{0, 132, "s_undefbehav_lj_0_width_9", s_undefbehav_lj_0_width_9, s_undefbehav_lj_0_width_9_bench, "{return test(\"%-09s\", s_hidden);}"},
	...
	{0, 432, "p_ftfc_literal_9w_prec2_undefbehav", p_ftfc_literal_9w_prec2_undefbehav, p_ftfc_literal_9w_prec2_undefbehav_bench, "{return test(\"%9.2p\n\", 1234);}"},
	{0, 433, "p_ftfc_literal_2w_prec9_undefbehav", p_ftfc_literal_2w_prec9_undefbehav, p_ftfc_literal_2w_prec9_undefbehav_bench, "{return test(\"%2.9p\n\", 1234);}"},
	{0, 434, "p_ftfc_zero_prec5_undefbehav", p_ftfc_zero_prec5_undefbehav, p_ftfc_zero_prec5_undefbehav_bench, "{return test(\"%.5p\", 0);}"},
	{0, 435, "p_ftfc_zero_prec0_undefbehav", p_ftfc_zero_prec0_undefbehav, p_ftfc_zero_prec0_undefbehav_bench, "{return test(\"%.0p\", 0);}"},
	...
	{0, 523, "nocrash_mandatory_wformat_undefbehav_01", nocrash_mandatory_wformat_undefbehav_01, nocrash_mandatory_wformat_undefbehav_01_bench, "{return test(\"%-021s\", \"abc\");}"},
	{0, 524, "nocrash_mandatory_wformat_undefbehav_02", nocrash_mandatory_wformat_undefbehav_02, nocrash_mandatory_wformat_undefbehav_02_bench, "{return test(\"%-05s\", \"goes over\");}"},
	{0, 525, "nocrash_mandatory_wformat_undefbehav_03", nocrash_mandatory_wformat_undefbehav_03, nocrash_mandatory_wformat_undefbehav_03_bench, "{return test(\"%04.3s%-7.4s\", \"hello\", \"world\");}"},
	{0, 526, "nocrash_mandatory_wformat_undefbehav_04", nocrash_mandatory_wformat_undefbehav_04, nocrash_mandatory_wformat_undefbehav_04_bench, "{return test(\"%021s\", NULL);}"},
	{0, 527, "nocrash_mandatory_wformat_undefbehav_05", nocrash_mandatory_wformat_undefbehav_05, nocrash_mandatory_wformat_undefbehav_05_bench, "{return test(\"%02s\", NULL);}"},
	{0, 528, "nocrash_mandatory_wformat_undefbehav_06", nocrash_mandatory_wformat_undefbehav_06, nocrash_mandatory_wformat_undefbehav_06_bench, "{return test(\"%-021s\", NULL);}"},
	{0, 529, "nocrash_mandatory_wformat_undefbehav_07", nocrash_mandatory_wformat_undefbehav_07, nocrash_mandatory_wformat_undefbehav_07_bench, "{return test(\"%-03s\", NULL);}"},
	{0, 530, "nocrash_mandatory_wformat_undefbehav_38", nocrash_mandatory_wformat_undefbehav_38, nocrash_mandatory_wformat_undefbehav_38_bench, "{return test(\"%05c\", '\0');}"},
	{0, 531, "nocrash_mandatory_wformat_undefbehav_39", nocrash_mandatory_wformat_undefbehav_39, nocrash_mandatory_wformat_undefbehav_39_bench, "{return test(\"%-05c\", '\0');}"},
